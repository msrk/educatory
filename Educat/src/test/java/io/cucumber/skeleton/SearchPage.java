...
public class SearchPage {
    ...
    public void searchStudy(){
        String search = "(//input[@type='search'])[1]";
        WaitFor(webDriverInstance, search);
        webDriverInstance.findElement(By.xpath(search)).click();
    ...
    public void WaitFor(WebDriver driver,String xpath ){
